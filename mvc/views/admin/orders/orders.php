...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.pagination li a.page-link', function(e) {
            ...
            callback('/quan-ly-tour/admin/orders/pagination_page', data);
        });
    ...
    if (event.target && event.target.id === 'search-input') {
        ...
        xhr.open('GET', '/quan-ly-tour/admin/orders/searchOrders?search=' + encodeURIComponent(searchTerm), true);
        xhr.send();
    }
});
    ...
    $(document).on('click', '.chitiet-btn', function(e) {
        ...
        window.location.href = '/quan-ly-tour/admin/orders/detail?id=' + orderId;
    });
</script>