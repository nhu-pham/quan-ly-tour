...
<body style="display:flex">
    ...
    <div class="d-flex flex-column align-items-center bg-light sidebar p-3">
        ...
        <ul class="nav flex-column w-100">
            ...
            <li class="nav-item mb-2">
                <a href="/quan-ly-tour/manager/tour/" class="nav-link text-dark fw-bold">Tour</a>
            </li>
            <li class="nav-item mb-2">
                <a href="/quan-ly-tour/manager/order/" class="nav-link text-dark fw-bold" style="display: none;">Đơn đặt tour</a>
            </li>
            <li class="nav-item mb-2">
                <a href="/quan-ly-tour/manager/service/" class="nav-link text-dark fw-bold">Dịch vụ</a>
            </li>
            <li class="nav-item mb-2">
                <a href="/quan-ly-tour/manager/review/" class="nav-link text-dark fw-bold">Nhận xét</a>
            </li>
            <li class="nav-item mb-2">
                <a href="/quan-ly-tour/manager/role/" class="nav-link text-dark fw-bold" style="display: none;">Phân quyền</a>
            </li>
        </ul>
    </div>
