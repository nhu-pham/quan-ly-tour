            ...
            <div class="booking-info">
                <div class="left-section">
                    <div class="form-group">
                        ...
                        <input type="text" id="customerCode" name="fullname" value="<?php echo htmlspecialchars($data['fullname']); ?>" readonly required>
                    </div>
                    <div class="form-group">
                        <label for="contactInfo"><strong>Thông tin liên hệ</strong></label>
                        <div>
                            <input type="text" id="contactInfo" name="phone_number" value="<?php echo htmlspecialchars($data['phone_number']); ?>" required >
                            <input type="text" id="emailInfo" name="email" value="<?php echo htmlspecialchars($data['email']); ?>" required>
                            <input type="text" id="locationInfo" name="address" value="<?php echo htmlspecialchars($data['address']); ?>" required>
                        </div>
                    </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (cancelButton) {
            cancelButton.addEventListener("click", function(event) {
                ...
                if (confirm("Bạn có chắc chắn muốn huỷ đơn hàng này không?")) {
                    fetch("/quan-ly-tour/manager/orders/cancel", {
                            method: "POST",
                            headers: {
        ...
        if (exportPDFButton) {
            exportPDFButton.addEventListener("click", function(event) {
                ...
                fetch("/quan-ly-tour/manager/orders/exportPDF", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json"
                        },
        ...
        if(backButton) {
            backButton.addEventListener("click", function(event) {
                event.preventDefault();
                window.location.href = "/quan-ly-tour/manager/orders"
            });
        }
    });
</script>