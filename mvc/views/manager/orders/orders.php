<div id="tourlist-container" class="tourlist-container customer-container container">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.pagination li a.page-link', function(e) {
            ...
            callback('/quan-ly-tour/manager/orders/pagination_page', data);
        });
    ...
    if (event.target && event.target.id === 'search-input') {
        ...
        xhr.open('GET', '/quan-ly-tour/manager/orders/searchOrders?search=' + encodeURIComponent(searchTerm), true);
        xhr.send();
    }
});
    ...
    $(document).on('click', '.chitiet-btn', function(e) {
        ...
        window.location.href = '/quan-ly-tour/manager/orders/detail?id=' + orderId;
    });
</script>